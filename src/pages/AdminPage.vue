        ...
        <ul class="space-y-2 font-medium">
          ...
          <li @click="currentTab = 3">
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Compensation</span>
            </a>
          </li>
    ...
    <div class="p-4 sm:ml-64">
      <div>
        <Transition name="fade" mode="out-in">
          ...
          <OrganizationsView v-else-if="currentTab === 1" />
          <SchedulesView v-else-if="currentTab === 2" />
          <CompensationView v-else-if="currentTab === 3" />
        </Transition>
      </div>
    </div>
  </div>
